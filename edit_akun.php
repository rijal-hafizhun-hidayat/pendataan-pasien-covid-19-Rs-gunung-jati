...
$data_edit = mysqli_query($konek, "SELECT * FROM akun WHERE id_akun = $id_akun ");
$tampil = mysqli_fetch_array($data_edit);
if (isset($_POST['edit'])) {
    $username = $_POST['username'];
    $password = $_POST['password'];
    $level = $_POST['level'];
    $sql = "UPDATE akun SET username = '$username', password = '$password', level = '$level' WHERE id_akun = '$id_akun' ";
                ...
                <div class="container-fluid">
                    ...
                    <form class="bayar" method="POST" action="">
                        <div class="form-group">
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputEmail" value="<?php echo $tampil['username']; ?>" placeholder="Masukkan Username" name="username">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputEmail" value="<?php echo $tampil['password']; ?>" placeholder="Masukkan Password" name="password">
                            </div>
                            <div class="form-group">
