                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['submit'])) {
                                            $_SESSION['pilih'] = $_POST['submit'];
                                            $cari = $_POST['find'];
                                            $_SESSION['cari'] = $cari;
                                            $tampil = "SELECT * FROM bayar WHERE nama_pembayar LIKE'%$cari%'";
                                        } else {
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) { ?>
                                            <tr>
                                                <th><?php echo $row['id_bayar']; ?></th>
                                                <th><?php echo $row['nama_pembayar']; ?></th>
                                                <th><?php echo $row['gender']; ?></th>
                                                <th><?php if ($row['level_ruang'] >= 500000 && $row['level_ruang'] < 1000000) {
                                                        echo "Reguler";
                                                    } else {
                                                        echo "Premium";
                                                    } ?></th>
                                                <th>
                                                    <a href="hapus_pasien.php?id_bayar=<?php echo $row['id_bayar']; ?>" class="marg btn btn-danger btn-circle">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                    <a href="edit_pasien.php?id_bayar=<?php echo $row['id_bayar']; ?>" class="btn btn-info btn-circle">
                            ...
                            <a href="cetak_pdf.php" type="button" class="btn btn-primary" target="_blank">Cetak Pdf</a>
                        </div>
                    </div>
