<?php 
    ...
    $sql_2 = "SELECT * FROM banyak_ruang";
    $sql_3 = "SELECT * FROM akun";
    $data_pasien = mysqli_query($konek, $sql);
    $data_ruang = mysqli_query($konek, $sql_2);
    $data_akun = mysqli_query($konek, $sql_3);
    $row = mysqli_fetch_array($data_ruang);
    $jumlah_pasien = mysqli_num_rows($data_pasien);
    $baris = 50;
    $baris = $baris - $jumlah_pasien;
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Sisa Ruang COVID - 19</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $baris; ?></div>
                                        </div>
                                        <div class="col-auto">
