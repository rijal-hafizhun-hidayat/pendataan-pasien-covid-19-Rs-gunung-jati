<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $pass = $_POST['pass'];
        $level = $_POST['level'];
        $sql = "INSERT INTO akun (username, password, level) VALUES ('$user', '$pass', '$level')";
                    ...
                    <div class="container-fluid">
                        ...
                        <form class="user" method="POST" action="">
                            <div class="form-group">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="user" name="user" required="" id="exampleInputEmail" placeholder="Masukkan Username">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" id="pass" name="pass" required="" id="exampleInputPassword" placeholder="Masukkan Password">
                                </div>
                                <div class="form-group">
                                    <select class="form-control" id="level" name="level" aria-label="Default select example" required="">
                                        <option selected value="">Pilih Level Akun</option>
